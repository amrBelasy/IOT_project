                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material">
                            <div class="text-center">
                                <img class="img-fluid" src="assets/images/auth/logo-dark.png" alt="Theme-Logo">
                            </div>
                            <div class="auth-box">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <p class="text-inverse b-b-default text-right">Back to <a href="auth-normal-sign-in.html">Login.</a></p>
...
<![endif]-->
    ...
    <script type="text/javascript" src="../lib/modernizr/js/css-scrollbars.js"></script>
    <!-- i18next.min.js -->
